...
//#define STAPSK  "39012804025281118581"  //Enter Passkey
//#endif
//const char* MQTT_BROKER = "192.168.178.51";  //Name of the mqtt broker
...
void wifi_config(){
  ...
  if(newWifi){
    i_pos=0;
    //inputt="FRITZ!Box 7530;39012804025281118581;192.168.178.51;";
    while(inputt[i_pos]!=';'){
